# API文档/大陆/行业接口/国证/财务报表/非金融

> Vibe Coding URL: https://www.lixinger.com/api/open-api/html-doc/cn/industry/fs/cni/non_financial
> API Key: `cn/industry/fs/cni/non_financial`
...
**请求URL:** `https://open.lixinger.com/api/cn/industry/fs/cni/non_financial`

**url for vibe coding:** [https://www.lixinger.com/api/open-api/html-doc/cn/industry/fs/cni/non_financial](https://www.lixinger.com/api/open-api/html-doc/cn/industry/fs/cni/non_financial)
...
| stockCodes | Yes | Array | 行业代码数组。 stockCodes长度>=1且<=100，格式如下：["C05","C06"]。 请参考 行业信息API 获取合法的stockCode。 需要注意的是，当传入startDate时只能传入一个股票代码。 |
