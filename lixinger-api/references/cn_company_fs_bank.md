# API文档/大陆/公司接口/财务报表/银行

> Vibe Coding URL: https://www.lixinger.com/api/open-api/html-doc/cn/company/fs/bank
> API Key: `cn/company/fs/bank`
...
**请求URL:** `https://open.lixinger.com/api/cn/company/fs/bank`

**url for vibe coding:** [https://www.lixinger.com/api/open-api/html-doc/cn/company/fs/bank](https://www.lixinger.com/api/open-api/html-doc/cn/company/fs/bank)
...
| stockCodes | Yes | Array | 股票代码数组。 stockCodes长度>=1且<=100，格式如下：["600016","601398"]。 请参考 股票信息API 获取合法的stockCode。 需要注意的是，当传入startDate时只能传入一个股票代码。 |
