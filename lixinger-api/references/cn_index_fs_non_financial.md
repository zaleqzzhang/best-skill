# API文档/大陆/指数接口/财务报表/非金融

> Vibe Coding URL: https://www.lixinger.com/api/open-api/html-doc/cn/index/fs/non_financial
> API Key: `cn/index/fs/non_financial`
...
**请求URL:** `https://open.lixinger.com/api/cn/index/fs/non_financial`

**url for vibe coding:** [https://www.lixinger.com/api/open-api/html-doc/cn/index/fs/non_financial](https://www.lixinger.com/api/open-api/html-doc/cn/index/fs/non_financial)
...
| stockCodes | Yes | Array | 指数代码数组。 stockCodes长度>=1且<=100，格式如下：["000932","000991"]。 请参考 指数信息API 获取合法的stockCode。 需要注意的是，当传入startDate时只能传入一个股票代码。 |
...
```json
{
    ...
    "data": [
        ...
        },
        {
            "date": "2025-09-30T00:00:00+08:00",
            "currency": "CNY",
            "reportDate": "2025-11-13T00:00:00+08:00",
            "reportType": "third_quarterly_report",
            "standardDate": "2025-09-30T00:00:00+08:00",
            "q": {
                "ps": {
