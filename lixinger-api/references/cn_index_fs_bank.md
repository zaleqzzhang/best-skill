# API文档/大陆/指数接口/财务报表/银行

> Vibe Coding URL: https://www.lixinger.com/api/open-api/html-doc/cn/index/fs/bank
> API Key: `cn/index/fs/bank`
...
**请求URL:** `https://open.lixinger.com/api/cn/index/fs/bank`

**url for vibe coding:** [https://www.lixinger.com/api/open-api/html-doc/cn/index/fs/bank](https://www.lixinger.com/api/open-api/html-doc/cn/index/fs/bank)
...
| stockCodes | Yes | Array | 指数代码数组。 stockCodes长度>=1且<=100，格式如下：["399986"]。 请参考 指数信息API 获取合法的stockCode。 需要注意的是，当传入startDate时只能传入一个股票代码。 |
