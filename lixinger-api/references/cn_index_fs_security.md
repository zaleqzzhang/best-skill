# API文档/大陆/指数接口/财务报表/证券

> Vibe Coding URL: https://www.lixinger.com/api/open-api/html-doc/cn/index/fs/security
> API Key: `cn/index/fs/security`
...
**请求URL:** `https://open.lixinger.com/api/cn/index/fs/security`

**url for vibe coding:** [https://www.lixinger.com/api/open-api/html-doc/cn/index/fs/security](https://www.lixinger.com/api/open-api/html-doc/cn/index/fs/security)
...
| stockCodes | Yes | Array | 指数代码数组。 stockCodes长度>=1且<=100，格式如下：["399975","399437"]。 请参考 指数信息API 获取合法的stockCode。 需要注意的是，当传入startDate时只能传入一个股票代码。 |
