# API文档/大陆/行业接口/国证/基本面数据

> Vibe Coding URL: https://www.lixinger.com/api/open-api/html-doc/cn/industry/fundamental/cni
> API Key: `cn/industry/fundamental/cni`
...
**请求URL:** `https://open.lixinger.com/api/cn/industry/fundamental/cni`

**url for vibe coding:** [https://www.lixinger.com/api/open-api/html-doc/cn/industry/fundamental/cni](https://www.lixinger.com/api/open-api/html-doc/cn/industry/fundamental/cni)
...
| stockCodes | Yes | Array | 行业代码数组。 stockCodes长度>=1且<=100，格式如下：["C07"]。 请参考 行业信息API 获取合法的stockCode。 需要注意的是，当传入startDate时只能传入一个股票代码。 |
    ...
    "data": [
        {
            ...
            "pe_ttm.y10.mcw.cvpos": 0.3396537510305029,
            "pe_ttm.mcw": 7.691060517609447,
            "mc": 22061502240597.547,
            "stockCode": "C07"
        }
    ]
}
